...
set -x
gcc -o console PDP11/console.c -I . -I ./PDP11
#
gcc -std=c99 -U__STRICT_ANSI__ -finline-functions -fgcse-after-reload \
 ...
 -fno-strict-overflow -DSIM_GIT_COMMIT_ID=000000001 -I . -I /usr/include/pcap \
 -DSIM_COMPILER="GCC Version: 4.8.5" -D_GNU_SOURCE -DHAVE_DLOPEN=so \
 -DHAVE_GLOB  -DOPCON  \
 ...
 PDP11/pdp11_td.c  PDP11/pdp11_io_lib.c  \
 ...
 -DVM_PDP11 -I PDP11 -I . -lm -o pdp11_new -lm -lrt -lpthread -ldl \
 -L/usr/lib
